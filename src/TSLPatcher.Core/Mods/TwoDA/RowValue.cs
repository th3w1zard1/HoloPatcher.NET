...
namespace TSLPatcher.Core.Mods.TwoDA
{
    ...
    {
        public abstract string Value(PatcherMemory memory, Core.Formats.TwoDA.TwoDA twoda, [CanBeNull] TwoDARow row);
    }
    ...
    public class RowValueConstant : RowValue
    {
        ...
        public override string Value(PatcherMemory memory, Core.Formats.TwoDA.TwoDA twoda, [CanBeNull] TwoDARow row)
        {
            return String;
        }
