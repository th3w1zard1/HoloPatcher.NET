...
/// </summary>
public class GFFStruct(int structId = 0) : IEnumerable<(string label, GFFFieldType fieldType, object value)>
{
    public int StructId { get; set; } = structId;

    private readonly Dictionary<string, GFFField> _fields = new();
