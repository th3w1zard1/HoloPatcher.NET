...
namespace TSLPatcher.Core.Formats.NCS
{
    ...
    public class NCSBinaryWriter
    {
        ...
        private readonly Dictionary<NCSInstruction, int> _offsets = new Dictionary<NCSInstruction, int>();
        private readonly Dictionary<NCSInstruction, int> _sizes = new Dictionary<NCSInstruction, int>();
