...
public class NCSCompiler
{
    ...
    public NCSCompiler(string? nwnnsscompPath, string tempScriptFolder, PatchLogger logger)
    {
    ...
    public bool ValidateCompiler()
    {
        ...
        try
        {
            ...
            if (productName?.Contains("TSLPATCHER", StringComparison.OrdinalIgnoreCase) == true)
            {
                return true;
            }
