@echo off
REM Matching PyKotor implementation at vendor/PyKotor/scripts/generate_scriptdefs.bat
REM Original: Wrapper script for generate_scriptdefs.py
